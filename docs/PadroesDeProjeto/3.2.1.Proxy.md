...
|--------|------------|------------------------|------------------|-------------------|------------------|
| `1.0` | 31/05/2025  | Criação do documento e conteúdo. | [Genilson Silva](https://github.com/GenilsonJrs), [Pedro Henrique](https://github.com/PedroHhenriq), [Nicollas Gabriel](https://github.com/Nicollaxs) ||  |