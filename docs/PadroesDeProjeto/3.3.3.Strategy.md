...
<font size="3"><p style="text-align: center"><b>Autor:</b> <a href="">[Genilson Silva](https://github.com/GenilsonJrs), [Gustavo Alves](https://github.com/gustaallves) e [Marcos Antonio](https://github.com/Marcosatc147)</a>, 2025.</p></font>
</center>
...
![Teste Proxy](../assets/img/testestrategy.jpg)
...
|--------|------------|------------------------|------------------|-------------------|------------------|
| `1.0` | 02/05/2025  | Criação do documento e conteúdo. | [Genilson Silva](https://github.com/GenilsonJrs), [Gustavo Alves](https://github.com/gustaallves), [Marcos Antonio](https://github.com/Marcosatc147) |  ||