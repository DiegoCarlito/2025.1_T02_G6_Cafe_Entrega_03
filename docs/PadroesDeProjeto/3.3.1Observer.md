...
|--------|------------|------------------------|------------------|-------------------|------------------|
| `1.0` | 01/06/2025  | Criação do documento e conteúdo. | [Nicollas Gabriel](https://github.com/Nicollaxs), [Samuel Ribeiro](https://github.com/SamuelRicosta), [João Vitor](https://github.com/Joa0V)  | - | - |